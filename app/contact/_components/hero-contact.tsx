...
export const HeroContact = () => {
  ...
  return (
    <section
      id="contact"
      className="w-full h-fit scroll-mt-14 items-start justify-start grid grid-cols-1 lg:grid-cols-2 px-5 md:px-7 lg:px-14 xl:px-36 2xl:px-56 pt-24 py-20 md:py-24 md:pt-28 lg:py-28 lg:pt-32 xl:py-36 2xl:py-48 gap-y-10 lg:gap-y-14 bg-muted relative"
    >
      <div className="absolute inset-0 overflow-hidden z-[1]">
        <Video
          poster="/contact-video-poster.png"
      ...
      <div className="w-full h-fit items-start justify-start flex flex-col gap-y-10 lg:gap-y-14 z-[2]">
        <div className="w-full h-fit items-center justify-center flex flex-col gap-y-1.5 lg:gap-y-3 drop-shadow-md">
          <BlurFade inView delay={0}>
            <h1 className="text-5xl lg:text-5xl 2xl:text-7xl font-semibold text-background tracking-tight">
          ...
          <BlurFade inView delay={0.1}>
            <p className="text-base lg:text-lg text-background/80 font-medium">
              ...
              realidad. Completa el formulario y uno de nuestros especialistas
              se pondrá en contacto contigo para comenzar a planear cada
              detalle.
            </p>
          </BlurFade>
        </div>
      </div>
      <div className="w-full max-w-xl items-center justify-center mx-auto bg-background border p-3 lg:p-5 z-[2]">
        <Form {...form}>
          <form

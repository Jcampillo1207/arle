          ...
          <div className="w-full flex items-end justify-between">
            <div className="w-full max-w-2xl items-starts justify-start flex flex-col gap-y-1.5">
              ...
              <p className="text-sm lg:text-base text-muted-foreground">
                ...
                civil y remodelaciones hasta gestión de proyectos llave en mano.
                Nuestro enfoque combina eficiencia, seguridad y calidad para
                llevar a cabo obras que superan expectativas.
              </p>
            </div>

        ...
        <div className="w-full flex flex-col gap-y-1.5 items-start justify-start">
          <BlurFade inView delay={0}>
            <h2 className="text-3xl md:text-3xl xl:text-4xl font-semibold text-background tracking-tight">
              <span className="text-foreground">##</span> Construimos hogares
              que reflejan tu estilo de vida
            </h2>
          </BlurFade>
          <BlurFade inView delay={0.1}>
            <p className="text-sm lg:text-base font-medium text-background/80">
              Transformamos tus ideas en espacios reales, funcionales y
              duraderos. Nos especializamos en la construcción de viviendas
              personalizadas que combinan diseño, calidad y comodidad. Ya sea tu
              primera casa o el hogar de tus sueños, estamos listos para hacerlo
              realidad, estés donde estés en México.
            </p>
          </BlurFade>
        </div>

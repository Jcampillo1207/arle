      ...
      <div className="w-full gap-y-7 lg:gap-y-10 flex flex-col items-start justify-start">
        <div className="w-full max-w-2xl items-starts justify-start flex flex-col gap-y-1.5">
          ...
          <p className="text-sm lg:text-base text-muted-foreground">
            Cada obra que realizamos habla por sí sola. Nos enorgullece entregar
            proyectos residenciales, comerciales e industriales que combinan
            diseño, funcionalidad y acabados impecables. Nuestra pasión por la
            construcción se ve reflejada en cada detalle.
          </p>
        </div>
